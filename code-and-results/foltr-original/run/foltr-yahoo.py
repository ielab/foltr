...
n_features = 700
n_folds = 1
data = MqDataset.from_path("./data/Yahoo/", n_features, n_folds, "./cache/")
...
np.save("./results/v0_yahoo_foltr_results.npy", exp_results)
#
...
#
# plt.show()
# f.savefig(f'./results/v0_yahoo_foltr_per_batch.png')
